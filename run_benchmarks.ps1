...
$executables = @("TPE_abb20_2step.exe","TPE_abb80_2step.exe","TPE_abb320_2step.exe", "TPE_abb20_3step.exe","TPE_abb80_3step.exe","TPE_abb320_3step.exe")  # Custom list of executables
