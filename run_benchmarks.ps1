...
$executables = @("test0.exe","test_micro.exe","test_micro2.exe", "TPE_abb20_2step.exe","TPE_abb80_2step.exe", "TPE_abb20_3step.exe","TPE_abb80_3step.exe")  # Custom list of executables
